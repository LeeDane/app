 ...
 */
public class MoodDetailActivity extends BaseActivity implements View.OnLongClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView(){
        ...
        viewHeader = LayoutInflater.from(MoodDetailActivity.this).inflate(R.layout.mood_detail_header, null);
        ...
        viewFooter = LayoutInflater.from(MoodDetailActivity.this).inflate(R.layout.listview_footer_item, null);
        ...
        if(StringUtil.isNotNull(praiseList) && detail.getInt("zan_number") > 0){
            ...
            for(String user: users){
                if(StringUtil.isNotNull(user)){
                    textView = new TextView(MoodDetailActivity.this);
                    ...
                    textView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            CommonHandler.startPersonalActivity(MoodDetailActivity.this, Integer.parseInt(u[0]));
                        }
                    });
            ...
            TextView endTextView = new TextView(MoodDetailActivity.this);
    ...
    public void taskFinished(TaskType type, Object result) {
        ...
        try{
            ...
            if(type == TaskType.DETAIL_MOOD){
                ...
                JSONObject resultObject = new JSONObject(String.valueOf(result));
                if(resultObject.has("isSuccess") && resultObject.getBoolean("isSuccess")){
                    Toast.makeText(MoodDetailActivity.this, "该图片已成功加入我的图库" +resultObject, Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(MoodDetailActivity.this, "加入我的图库失败"+(resultObject.has("message") ? ",原因是：" + resultObject.getString("message"):""), Toast.LENGTH_LONG).show();
                }
                ...
                if(responseCommentBean != null && responseCommentBean.isSuccess()){
                    ...
                    if(commentOrTransmitBeans != null && commentOrTransmitBeans.size() > 0){
                        ...
                        if(!mPreLoadMethod.equalsIgnoreCase("uploading")){
                            ...
                            Toast.makeText(MoodDetailActivity.this, getResources().getString(R.string.no_load_more), Toast.LENGTH_LONG).show();
                        }
                    }
                }else{
                    if(!mPreLoadMethod.equalsIgnoreCase("uploading")){
                ...
                if(jsonObject != null && jsonObject.has("isSuccess") && jsonObject.getBoolean("isSuccess") == true){
                    new NotificationUtil(1, MoodDetailActivity.this).sendTipNotification("信息提示", "您的评论发表成功", "测试", 1, 0);
                ...
                if (jsonObject != null && jsonObject.has("isSuccess") && jsonObject.getBoolean("isSuccess") == true) {
                    ...
                    Toast.makeText(MoodDetailActivity.this, "点赞失败", Toast.LENGTH_SHORT).show();
                }
            }
        }catch (JSONException e){
            e.printStackTrace();
    ...
    private void sendFirstLoading(){
       ...
       // mCommentOrTransmits.clear();
        if(commentOrTransmit == 0) {
            ...
            //mCommentOrTransmitAdapter = new CommentOrTransmitAdapter(MoodDetailActivity.this, mCommentOrTransmits, true);
            CommentHandler.getCommentsRequest(MoodDetailActivity.this, params);
           ...
           // mTransmitAdapter = new TransmitAdapter(MoodDetailActivity.this, mCommentOrTransmits);
            TransmitHandler.getTransmitsRequest(MoodDetailActivity.this, params);
        }
    ...
    public void sendLoadAgain(View view){
        ...
        if(getResources().getString(R.string.load_more_error).equalsIgnoreCase(mListViewFooter.getText().toString())
            ...
            Toast.makeText(MoodDetailActivity.this, "请求重新加载", Toast.LENGTH_SHORT).show();
            taskCanceled(TaskType.LOAD_COMMENT);
            taskCanceled(TaskType.LOAD_TRANSMIT);
            isLoading = true;
            HashMap<String, Object> params = new HashMap<String, Object>();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.mood_detail_img:
                Intent it_detail = new Intent(MoodDetailActivity.this, ImageDetailActivity.class);
            ...
            case R.id.mood_detail_comment_or_transmit_send:
                ...
                if(StringUtil.isNull(commentOrTransmitText) && commentOrTransmit == 0){
                    Toast.makeText(MoodDetailActivity.this, "评论内容不能为空", Toast.LENGTH_SHORT).show();
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(this).setTitle("添加图库")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                TaskLoader.getInstance().startTaskForResult(TaskType.ADD_GALLERY, MoodDetailActivity.this, requestBean);
