...
public class CircularImageView extends ImageView {
    ...
    private void setup() {
        ...
        /**
         * 系统5.0添加的新特性，必须引入Support v7
         * Palette从图像中提取突出的颜色，这样可以把色值赋给ActionBar、或者其他，
         * 可以让界面整个色调统一，效果见上图（Palette）
        ...
        if (palette.getLightVibrantSwatch() != null) {
            ...
            mBorderColor = palette.getLightVibrantSwatch().getRgb();
            //mBorderColor = palette.getLightVibrantSwatch().getRgb();
            //mBorderColor = palette.getDarkVibrantSwatch().getRgb();
            //mBorderColor = palette.getLightMutedSwatch().getRgb();
            //mBorderColor = palette.getDarkMutedSwatch().getRgb();
        }
