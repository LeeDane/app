...
public class TwoLevelCategoryDataBase {
    ...
    public static List<TwoLevelCategory> initData(){
        ...
        twoLevelCategories.add(new TwoLevelCategory(101, "早午晚餐", true, 1));
        twoLevelCategories.add(new TwoLevelCategory(101, "烟酒茶", false, 2));
        twoLevelCategories.add(new TwoLevelCategory(101, "水果零食", false, 3));

        twoLevelCategories.add(new TwoLevelCategory(102, "衣服裤子", false, 4));
        twoLevelCategories.add(new TwoLevelCategory(102, "鞋帽包包", false, 5));
        twoLevelCategories.add(new TwoLevelCategory(102, "化妆饰品", false, 6));

        twoLevelCategories.add(new TwoLevelCategory(103, "日常用品", false, 7));
        twoLevelCategories.add(new TwoLevelCategory(103, "水电煤气", false, 8));
        twoLevelCategories.add(new TwoLevelCategory(103, "房租", false, 9));
        twoLevelCategories.add(new TwoLevelCategory(103, "物业管理", false, 10));
        twoLevelCategories.add(new TwoLevelCategory(103, "维修保养", false, 11));

        twoLevelCategories.add(new TwoLevelCategory(104, "公共地铁", false, 12));
        twoLevelCategories.add(new TwoLevelCategory(104, "打车租车", false, 13));
        twoLevelCategories.add(new TwoLevelCategory(104, "私家车费用", false, 14));

        twoLevelCategories.add(new TwoLevelCategory(105, "座机费", false, 15));
        twoLevelCategories.add(new TwoLevelCategory(105, "手机话费", false, 16));
        twoLevelCategories.add(new TwoLevelCategory(105, "上网费", false, 17));
        twoLevelCategories.add(new TwoLevelCategory(105, "邮寄费", false, 18));

        twoLevelCategories.add(new TwoLevelCategory(106, "运动健身", false, 19));
        twoLevelCategories.add(new TwoLevelCategory(106, "腐败聚会", false, 20));
        twoLevelCategories.add(new TwoLevelCategory(106, "休闲玩乐", false, 21));
        twoLevelCategories.add(new TwoLevelCategory(106, "宠物宝贝", false, 22));
        twoLevelCategories.add(new TwoLevelCategory(106, "旅游度假", false, 23));

        twoLevelCategories.add(new TwoLevelCategory(107, "书报杂志", false, 24));
        twoLevelCategories.add(new TwoLevelCategory(107, "培训进修", false, 25));
        twoLevelCategories.add(new TwoLevelCategory(107, "数码装备", false, 26));

        twoLevelCategories.add(new TwoLevelCategory(108, "送礼请客", false, 27));
        twoLevelCategories.add(new TwoLevelCategory(108, "孝敬长辈", false, 28));
        twoLevelCategories.add(new TwoLevelCategory(108, "还人钱物", false, 29));
        twoLevelCategories.add(new TwoLevelCategory(108, "慈善捐助", false, 30));

        twoLevelCategories.add(new TwoLevelCategory(109, "药品费", false, 31));
        twoLevelCategories.add(new TwoLevelCategory(109, "保健费", false, 32));
        twoLevelCategories.add(new TwoLevelCategory(109, "美容费", false, 33));
        twoLevelCategories.add(new TwoLevelCategory(109, "治疗费", false, 34));

        twoLevelCategories.add(new TwoLevelCategory(110, "银行手续", false, 35));
        twoLevelCategories.add(new TwoLevelCategory(110, "投资亏损", false, 36));
        twoLevelCategories.add(new TwoLevelCategory(110, "按揭还款", false, 37));
        twoLevelCategories.add(new TwoLevelCategory(110, "消费税收", false, 38));
        twoLevelCategories.add(new TwoLevelCategory(110, "利息支出", false, 39));
        twoLevelCategories.add(new TwoLevelCategory(110, "赔偿罚款", false, 40));

        twoLevelCategories.add(new TwoLevelCategory(111, "其他支出", false, 41));
        twoLevelCategories.add(new TwoLevelCategory(111, "意外丢失", false, 42));
        twoLevelCategories.add(new TwoLevelCategory(111, "烂账丢失", false, 43));

        //收入大类
        twoLevelCategories.add(new TwoLevelCategory(112, "工资收入", false, 44));
        twoLevelCategories.add(new TwoLevelCategory(112, "利息收入", false, 45));
        twoLevelCategories.add(new TwoLevelCategory(112, "加班收入", false, 46));
        twoLevelCategories.add(new TwoLevelCategory(112, "奖金收入", false, 47));
        twoLevelCategories.add(new TwoLevelCategory(112, "投资收入", false, 48));
        twoLevelCategories.add(new TwoLevelCategory(112, "兼职收入", false, 49));

        twoLevelCategories.add(new TwoLevelCategory(113, "礼金收入", false, 50));
        twoLevelCategories.add(new TwoLevelCategory(113, "中奖收入", false, 51));
        twoLevelCategories.add(new TwoLevelCategory(113, "意外来钱", false, 52));
        twoLevelCategories.add(new TwoLevelCategory(113, "经营所得", false, 53));
    ...
    public static int getIndexByOneLevelCategory(String value){
        ...
        if(oneLevelGategories.size() > 0 ){
            for(OneLevelGategory oneLevelGategory: oneLevelGategories){
                if (value.equals(oneLevelGategory.getValue())){
                    id = oneLevelGategory.getOrder();
                    break;
                }
            }
        }
     ...
     * @param datas
     */
    public void reset(List<TwoLevelCategory> datas) {
        if (datas != null) {
            SQLiteDatabase sqlite = dbHelper.getWritableDatabase();
            // 删除全部
            sqlite.execSQL("delete from " + TWO_LEVEL_CATEGORY_TABLE_NAME);
            // 重新添加
