 ...
 */
public class TwoLevelEditAdapter extends BaseRecyclerViewAdapter<TwoLevelCategoryEdit> implements ItemTouchHelperAdapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        final TwoLevelCategoryEdit data = mDatas.get(position);
