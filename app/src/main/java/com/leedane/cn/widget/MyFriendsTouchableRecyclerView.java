 ...
 */
public class MyFriendsTouchableRecyclerView extends RecyclerView {

    private Context mContext;
    int Slop;

    public MyFriendsTouchableRecyclerView(Context context) {
        this(context, null);
    }

    public MyFriendsTouchableRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyFriendsTouchableRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void closeAllOpenedItem() {
        if (getAdapter() != null)
            ((MyFriendsAdapter) getAdapter()).closeOpenedSwipeItemLayoutWithAnim();
    }
}
